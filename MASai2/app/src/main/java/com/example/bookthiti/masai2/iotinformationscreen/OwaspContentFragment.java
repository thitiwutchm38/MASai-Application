...
public class OwaspContentFragment extends Fragment {
    ...
    public OwaspContentFragment() {
        // Required empty public constructor
    }

    public static OwaspContentFragment newInstance(String param1, String param2) {
        OwaspContentFragment fragment = new OwaspContentFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            mContentType = getArguments().getString(ARG_PARAM1);
